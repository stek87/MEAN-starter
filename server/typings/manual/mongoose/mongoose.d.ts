...
declare module "mongoose" {
    ...
    interface MongosOptions {
         ...
         * serverApp instance. (default: 5 (for legacy reasons)) */
        poolSize?: number;
        /**
         * Use ssl connection (needs to have a mongod serverApp with
         * ssl support). (default: false).
         */
        ssl?: boolean;
        /**
         * Validate mongod serverApp certificate against ca
         * (needs to have a mongod serverApp with ssl support, 2.4 or higher)
         * (default: true)
         */
        sslValidate?: boolean;
