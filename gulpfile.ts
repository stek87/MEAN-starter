...
gulp.task("clientResources", () => {
  return gulp.src(
    ["client/**/*", "!**/*.ts", "!client/typings", "!client/typings/**", "!client/*.json"]
  ).pipe(gulp.dest("dist/client"));
});
...
gulp.task("installTypings", function () {
  let stream = gulp.src(["./server/typings.json", "./client/typings.json"])
...
gulp.task('watch', function () {
  ...
  gulp.watch(["client/**/*.html", "client/**/*.css"], ['clientResources'])
